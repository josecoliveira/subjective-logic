...
class DecisionMaking(HyperopinionDecorator):
    ...
    def __init__(self, hyperopinion: HyperopinionInterface, utility):
        ...
        self.normalized_sharp_b = self.utility * self.sharp_b[0:self.k] / self.utility_max_abs
        self.normalized_vague_b = self.utility * self.sharp_b[0:self.k] / self.utility_max_abs
        self.normalized_focal_u = self.utility * self.focal_u[0:self.k] / self.utility_max_abs
